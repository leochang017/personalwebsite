...
const competitions = [
  ...
  { place: "1st", placeLabel: "1st Place", color: "bg-yellow-100 text-yellow-800 border-yellow-300", badgeColor: "bg-yellow-400 text-yellow-900", name: "National Ballroom Dance", org: "USA Dance — Sophomore Year", detail: "Won first place at the national ballroom dance competition as a sophomore.", logo: "/images/usadance.png", year: "2024" },
  { place: "Finalist", placeLabel: "National Finalist", color: "bg-yellow-100 text-yellow-800 border-yellow-300", badgeColor: "bg-yellow-200 text-yellow-800", name: "National Ballroom Dance", org: "USA Dance — Freshman Year", detail: "National finalist in ballroom dance competition as a freshman.", logo: "/images/usadance.png", year: "2023" },
  { place: "Finalist", placeLabel: "National Finalist", color: "bg-yellow-100 text-yellow-800 border-yellow-300", badgeColor: "bg-yellow-200 text-yellow-800", name: "National Ballroom Dance", org: "USA Dance — Junior Year", detail: "National finalist in ballroom dance competition as a junior.", logo: "/images/usadance.png", year: "2025" },
  { place: "2nd", placeLabel: "2nd Place", color: "bg-gray-100 text-gray-700 border-gray-300", badgeColor: "bg-gray-300 text-gray-800", name: "NJSIAA Fencing (Individual)", org: "State Championship", detail: "Earned second place at NJSIAA regional fencing championship, qualifying for state finals.", logo: "/images/njsiaa.jpg", year: "2025" },
  ...
  { place: "4th", placeLabel: "4th Place", color: "bg-blue-50 text-blue-700 border-blue-200", badgeColor: "bg-blue-300 text-blue-900", name: "National Economics Challenge", org: "State Level", detail: "Placed 4th at the state level of the National Economics Challenge.", logo: "/images/nec.png", year: "2024" },
];

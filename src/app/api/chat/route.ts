...
- Rutgers University, Research Intern with Prof. Yongfeng Zhang (Apr 2026-Present, ACTIVE, remote) — see Project 1 above. Skills: LLM Agents, Multi-Agent Systems, Python, Anthropic API, Climate ML, Research.
- Zhongke Guoguang Quantum, AI / ML Intern (Jun-Jul 2026, UPCOMING, Beijing, China) — upcoming summer internship at a quantum-technology company in Beijing. Details will be shared after the internship is completed; if asked for specifics, say they are coming soon.
- Hongik University, Research Intern (Jul-Aug 2026, UPCOMING, Seoul, South Korea) — upcoming summer research internship at Hongik University in Seoul. Details will be shared after the internship is completed; if asked for specifics, say they are coming soon.
...
Frameworks & libraries: Flask, Next.js/React, Node.js, TensorFlow/Keras, scikit-learn, NumPy/SciPy, SQLAlchemy, Anthropic API.
Tools & infrastructure: Git & GitHub Actions, PostgreSQL, AWS S3, Google Cloud (Run, Vision), Vercel, Godot, pytest & mypy.
Focus areas: Machine Learning, LLM Agents, Multi-Agent Systems, Full-Stack Web Dev, Data Science, Game Dev.

CONTACT: leochang017@gmail.com. Website: leochang.net. Instagram: instagram.com/leo.c000/. Resume: LeoChangResume_July2026.pdf (July 2026 version).

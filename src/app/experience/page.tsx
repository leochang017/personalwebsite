...
const experiences = [
  ...
  },
  {
    ...
    role: "Web Dev & Content Strategy Intern",
    period: "Jul – Sep 2025",
    location: "Remote",
    active: false,
...
const leadership = [
  ...
  },
  {
    ...
    desc: "Founded and lead a chess club at Princeton Day School with 20+ active members. Organize weekly tactics sessions, host in-school tournaments, and create an inclusive environment welcoming players of all skill levels from beginners to competitive players.",
